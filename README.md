...
1. Get code and enter project: `git clone https://github.com/striblab/20180117-mnpoll-taxes.git && cd 20180117-mnpoll-taxes.git`
...
2. Copy files (update path as needed): `mkdir -p ../20180117-mnpoll-taxes/ && rsync -rav ./ ../20180117-mnpoll-taxes/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
